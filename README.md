[![Build Status](https://github.com/gap-packages/ZeroMQInterface/workflows/CI/badge.svg?branch=master)](https://github.com/gap-packages/ZeroMQInterface/actions?query=workflow%3ACI+branch%3Amaster)
